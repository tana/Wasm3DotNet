...
namespace Wasm3DotNet
{
    ...
    /// <param name="ctx">Pointer to IM3ImportContext (Currently there is no way to convert it into a C# object)</param>
    ...
    public delegate IntPtr M3RawCall(IntPtr runtime, IntPtr ctx, IntPtr sp, IntPtr mem);
}
